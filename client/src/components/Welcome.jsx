    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4 w-full">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-8">
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd] bg-gradient-to-r from-orange-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500"
            >
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10 ml-50">
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 card bg-opacity-100 backdrop-blur-md backdrop-brightness-125 border-gray-200">
